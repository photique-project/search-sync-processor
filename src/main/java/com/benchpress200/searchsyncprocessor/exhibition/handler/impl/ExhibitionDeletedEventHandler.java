...
public class ExhibitionDeletedEventHandler implements ExhibitionEventHandler {
    ...
    public void handle(
        ...
        exhibitionSearchRepository.findById(exhibitionId)
                .ifPresent(exhibitionSearchRepository::delete);
    }
}
