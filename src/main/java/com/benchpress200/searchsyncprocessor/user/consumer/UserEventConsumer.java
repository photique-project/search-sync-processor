package com.benchpress200.searchsyncprocessor.user.consumer;
...
import com.benchpress200.searchsyncprocessor.user.dispatch.UserEventDispatcher;
...
public class UserEventConsumer {
    ...
    public void consume(ConsumerRecord<String, String> record) {
        ...
        try {
            UserEventPayload payload = EventParser.getPayload(
                    record,
                    UserEventPayload.class,
                    objectMapper
            );
